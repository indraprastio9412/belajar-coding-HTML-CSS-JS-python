...
class Translator(QWidget):
    ...
    def init_ui(self):
        ...
        bahasa = ["Arabic", "English", "French", "Indonesia", "Japanese", "Korean", "Afrikaans", "Malaysians", "Thai"]
        self.combo.addItems(bahasa)
        self.combo.setEditable(True)
        from PyQt5.QtCore import Qt
        self.combo.lineEdit().setAlignment(Qt.AlignCenter)
        vb.addWidget(self.combo)
        self.target = {"Arabic":"ar", "English":"en","French":"fr", "Indonesia":"id", "Japanese":"ja", "Korean":"ko", "Afrikaans":"af","Malaysians":"ms", "Thai":"th"}
...
def main():
    ...
    gui.setWindowTitle("Translit Bahasa")
    gui.show()
    sys.exit(app.exec_())
